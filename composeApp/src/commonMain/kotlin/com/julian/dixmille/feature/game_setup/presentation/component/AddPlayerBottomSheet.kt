            ...
            Column(
                ...
                Row(
                    ...
                    OutlinedTextField(
                        ...
                        label = {
                            Text(
                                stringResource(Res.string.add_player_unified_field_hint),
                                maxLines = 1,
                ...
                LazyColumn(
                    ...
                    items(state.filteredPlayers, key = { it.id.value }) { player ->
                        val isSelected =
                            state.selectedPlayers.any { it.id.value == player.id.value }
                        val subtitle = when {
                            ...
                            player.lastPlayedAt != null -> {
                                ...
                                when (days) {
                                    0L -> stringResource(Res.string.add_player_subtitle_today)
                                    1L -> stringResource(Res.string.add_player_subtitle_one_day_ago)
                                    else -> stringResource(
                                        Res.string.add_player_subtitle_days_ago,
                                        days
                                    )
                                }
                            }
